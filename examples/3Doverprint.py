...
target_geo = vam.geometry.TargetGeometry(stlfilename=vam.resources.load("screwdriver.stl"), resolution=200,
...
opt_sino, opt_recon, error = vam.optimize.optimize(target_geo, proj_geo, optimizer_params, n_processes=2)
opt_recon.show()
opt_sino.show()
